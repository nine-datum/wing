...
(defn test-setup [dev]
  (let
    [
      ...
      make-red (fn [preset n] (make-char preset [(- 0 5 (* 2 (quot n 5))) 0 (step (mod n 10))] [1 0 0] [1 0 0 1] :red))
      make-green (fn [preset n] (make-char preset [(+ 5 (* 2 (quot n 5))) 0 (step (mod n 10))] [-1 0 0] [0 1 0 1] :green))
      players (concat
